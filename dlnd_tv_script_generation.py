...
def get_init_cell(batch_size, rnn_size):
    ...
    multirnn_cell = tf.contrib.rnn.MultiRNNCell([basic_lstm_cell])
    initial_state = multirnn_cell.zero_state(batch_size,tf.float32)
    initial_state = tf.identity(initial_state,name='initial_state')
    return (multirnn_cell,initial_state)
...
def pick_word(probabilities, int_to_vocab):
    ...
    """
    # TODO: Implement Function
    return int_to_vocab[np.random.choice(list(int_to_vocab.keys()), p=probabilities)]
